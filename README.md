...
- **Логирование команд**: все взаимодействия с терминалом записываются со связями между AI запросами, командами и результатами
...
- **Просмотр логов команд**: интерактивная панель при наведении + отдельные страницы `/logs.html` и `/raw-logs.html`
