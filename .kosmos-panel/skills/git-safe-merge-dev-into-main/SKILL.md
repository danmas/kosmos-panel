Вот готовый текст для файла **SKILL.md**, который реализует описанный тобой сценарий максимально близко и безопасно.
...
Этот вариант довольно подробный, понятный и максимально защищает от случайных ошибок.

Если хочешь более компактный / менее разговорчивый стиль — дай знать, подкорректирую.
